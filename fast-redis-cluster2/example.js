var rcluster = require('fast-redis-cluster2/index.js').clusterClient;

var settings = {
	host: 'bv0nc60xz-redis.services.clever-cloud.com',
	port: 1356,
...
var t = new rcluster.clusterInstance(settings, function (err, r) {
	...
	function doIt() {
		r.set('foo', 'bar', function (err, reply) {
			...
			r.get('TagsData', function (err, reply) {
				if (err) throw err;
				console.log(err, reply);
			});
		});

		r.hgetall('hset:TagsData', function(e, d){
			console.log(e,d);
		});
